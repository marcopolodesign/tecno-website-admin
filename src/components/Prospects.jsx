          ...
          <div className="fixed inset-y-0 right-0 w-full max-w-md bg-white border-l border-[#edeaea] z-50 transform transition-transform duration-300 ease-in-out flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="space-y-4">
                ...
                {/* UTM Parameters */}
                {(selectedProspect.utmSource || selectedProspect.utmMedium || selectedProspect.utmCampaign || selectedProspect.utmTerm || selectedProspect.utmContent) && (
                  <div className="border-t border-[#edeaea] pt-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 space-y-2 text-sm">
                      {selectedProspect.utmSource && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">{selectedProspect.utmSource}</span>
                        </div>
                      )}
                      {selectedProspect.utmMedium && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Medium:</span>
                          <span className="font-medium text-gray-900">{selectedProspect.utmMedium}</span>
                        </div>
                      )}
                      {selectedProspect.utmCampaign && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Campaign:</span>
                          <span className="font-medium text-gray-900">{selectedProspect.utmCampaign}</span>
                        </div>
                      )}
                      {selectedProspect.utmTerm && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Term:</span>
                          <span className="font-medium text-gray-900">{selectedProspect.utmTerm}</span>
                        </div>
                      )}
                      {selectedProspect.utmContent && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Content:</span>
                          <span className="font-medium text-gray-900">{selectedProspect.utmContent}</span>
                        </div>
                      )}
                    </div>
                  </div>
